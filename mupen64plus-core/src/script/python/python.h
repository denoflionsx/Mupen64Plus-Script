#ifndef __M64P_PYTHON_H__
#define __M64P_PYTHON_H__

// ONLY TEMPORARY HERE
#include "api/m64p_types.h"
m64p_error m64p_python_load_script(const char* value);
int m64p_python_init();
void m64p_python_vi_callback();
void m64p_python_render_callback();
// ONLY TEMPORARY HERE
